package com.guilhermeyuji.workshopmongodb.config;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(null, "Partiu viagem", sdf.parse("21/03/2022"), "Vou viajar para São Paulo. Abraços!",
				new AuthorDTO(maria));
		Post post2 = new Post(null, "Bom dia", sdf.parse("23/03/20122"), "Acordei feliz hoje!", new AuthorDTO(maria));
